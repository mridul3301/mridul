...
const Work = () => (
  <Layout title="Attention">
      ...
      The "Attention is All You Need" paper, published in 2017 by Vaswani et al., introduced
      ...
      significantly faster training times.<br /><br />
      </P>
      <Heading as="h4" fontSize={14} my={6}>
      ...
      <List ml={6} my={6}>
        <ListItem>
          ...
          The paper introduces the attention mechanism as a fundamental building block for sequence 
          ...
          of different elements in the input sequence.<br /><br />
          </P>
        </ListItem>
        <ListItem>
          ...
          The authors propose the Transformer, a novel neural network architecture based solely on 
        ...
        <ListItem>
          ...
          Self-attention is a mechanism that computes attention weights within a sequence itself. 
          ...
          simultaneously, capturing both short-range and long-range dependencies.<br /><br />
          </P>
        </ListItem>
        <ListItem>
          ...
          To enhance the modeling capacity and enable capturing different types of dependencies, the 
          ...
          to jointly attend to information from different representation subspaces.<br /><br />
          </P>
        </ListItem>
        <ListItem>
          ...
          Since the Transformer lacks sequential information, positional encodings are introduced to 
        ...
        <ListItem>
          ...
          The paper describes the training process for the Transformer using the attention-based 
          ...
          autoregressively, where each output token is generated based on previously generated tokens.<br /><br />
          </P>
        </ListItem>
